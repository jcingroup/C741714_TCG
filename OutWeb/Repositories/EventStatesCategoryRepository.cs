...
//using OutWeb.Models.FrontModels.News.EventStatesCategoryModels;
//using System;
...
//{
//    public class EventStatesCategoryRepository
//    {
//        private string _connectionString { get; set; }
//        private ConnectionRepository conRepo = new ConnectionRepository();

//        public EventStatesCategoryRepository()
//        {
...
//        /// <returns></returns>
//        public EventStatesCategoryContent GetContentByID(int id, string lagCode)
//        {
//            EventStatesCategoryContent result = new EventStatesCategoryContent();
//            using (var db = new TCGDB(_connectionString))
//            {
...
//                result.Data = new EventStatesCategoryData()
//                {
//                    ID = source.ID,
//                    Title = source.C_TITLE,
//                    ImagesList = GetPaginImgsListByID(source.ID),
//                    InternetSiteList = GetPagingUrlListByID(source.ID),
//                    PublishDateString = source.C_DATE.Value.ToString("yyyy-MM-dd"),
//                    Remark.
//                };
//                result.Data.Remark = result.Data;
...
//        /// <returns></returns>
//        public EventStatesCategoryResult GetList(EventStatesCategoryListFilter filter)
//        {
//            EventStatesCategoryResult result = new EventStatesCategoryResult();
//            List<EventStatesCategoryData> data = new List<EventStatesCategoryData>();
//            using (var db = new TCGDB(_connectionString))
//            {
//                try
//                {
...
//                    {
//                        EventStatesCategoryData temp = new EventStatesCategoryData()
//                        {
//                            ID = item.ID,
//                            Title = item.C_TITLE,
...
//        /// <returns></returns>
//        public EventStatesCategoryResult ListPagination(ref EventStatesCategoryResult model, int page, int pageSize)
//        {
//            int startRow = 0;
