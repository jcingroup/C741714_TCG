...
namespace OutWeb.Repositories
{
    public class EventStatesRepository
    {
        ...
        /// <param name="langCode"></param>
        /// <returns></returns>
        public Dictionary<int, string> GetStatesCateByID(int id, string langCode)
        {
            Dictionary<int, string> cate = GetStatesCate(langCode)
                .Where(s => s.Key == id)
        ...
        private List<string> GetPagingUrlListByID(int id)
        {
            ...
            {
                data = db.URL
                    .Where(s => s.STATUS == "Y" && s.URL_KIND == "States_Detail" &&
        ...
        private string GetMainImg(int id)
        {
            ...
            {
                imgStr = db.IMG
                .Where(s => s.STATUS == "Y" && s.IMG_KIND == "States" &&
        ...
        /// <returns></returns>
        public EventStatesResult ListPagination(ref EventStatesResult model, int page, int pageSize)
        {
            int startRow = 0;
